...
import drawDriverless3D as D3D
...
class pygamesimLocal(Map, ML.mapLoader, CC.coneConnecter, PF.pathFinder, PP.pathPlanner, DD.pygameDrawer):
    def __init__(self, window, drawSize=(1280,360), drawOffset=(0,0), carCamOrient=0, sizeScale=120, startWithCarCam=False, invertYaxis=True):
...
camDrawer = D3D.pygameDrawer3D(sim1, DD.window, resolution)
