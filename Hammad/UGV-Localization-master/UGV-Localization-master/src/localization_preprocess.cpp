...
class LocalizationPreProcess
{
	...
	public:
		LocalizationPreProcess(ros::NodeHandle& nh) : nh_(nh) {
			LocalizationPreProcess::setupParams();
...
{
	ros::init(argc, argv, "localization_preprocess");
	ros::NodeHandle nh;

	LocalizationPreProcess localization_preprocess(nh);
