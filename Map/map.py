...
sims = ['PathPlanning','ConeConnecting','SLAM']

sim_to_run = sims[0]

##############

# some code to read a csv file and create variables from csv
...
class PathPlanning(Map):
    
    def __init__(self): #should 'Map' this be here
    ...
    def run(self):
        ...
        left_cones = self.left_cone_list
        right_cones = self.right_cone_list
        ...
        while not self.exit:
            ...
            if pressed[pygame.K_t]:
                    ...
                    if mouse_pos in mouse_pos_list:
                        ...
                        if make_target == True:
                            ...
                            target = Map.Target(mouse_pos[0]/ppu,mouse_pos[1]/ppu)
            ...
            if pressed[pygame.K_l]:
                ...
                if mouse_pos in mouse_pos_list:
                    ...
                    if make_cone == True:
                        left_cone = Map.Cone(mouse_pos[0]/ppu, mouse_pos[1]/ppu, 'left')
            ...
            if pressed[pygame.K_r]:
                ...
                if mouse_pos in mouse_pos_list:
                    ...
                    if make_cone == True:
                        right_cone = Map.Cone(mouse_pos[0]/ppu, mouse_pos[1]/ppu, 'right')
...
if __name__ == '__main__': 
    ...
    if sim_to_run == 'PathPlanning':
        sim = PathPlanning()
        
    elif sim_to_run == 'ConeConnecting':
        pass
        #sim = ConeConnecting()
        
    elif sim_to_run == 'SLAM':
        pass
       # sim = SLAM()
